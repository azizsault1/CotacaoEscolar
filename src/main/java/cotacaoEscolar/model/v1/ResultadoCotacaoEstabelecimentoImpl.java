...
public class ResultadoCotacaoEstabelecimentoImpl implements Comparable<ResultadoCotacaoEstabelecimentoImpl>, ResultadoCotacaoEstabelecimento {
   ...
   public ResultadoCotacaoEstabelecimentoImpl(final String nome) {
   ...
   @Override
   public int compareTo(final ResultadoCotacaoEstabelecimentoImpl o) {
